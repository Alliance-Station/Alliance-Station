#define ICON_WALL_PATH 'alliance_modules/modules/sprite_replacement/walls/icons/wall.dmi'
#define ICON_REINFORCED_PATH 'alliance_modules/modules/sprite_replacement/walls/icons/reinforced_wall.dmi'
#define ICON_METERIAL_PATH 'alliance_modules/modules/sprite_replacement/walls/icons/material_wall.dmi'
