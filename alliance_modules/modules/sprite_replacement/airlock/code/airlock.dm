...
//STATION AIRLOCKS
/obj/machinery/door/airlock
	icon = 'icons/airlocks/station/public.dmi'
	overlays_file = 'icons/airlocks/station/overlays.dmi'

/obj/machinery/door/airlock/command
	icon = 'icons/airlocks/station/command.dmi'

/obj/machinery/door/airlock/security
	icon = 'icons/airlocks/station/security.dmi'
...
/obj/machinery/door/airlock/security/blue
	icon = 'icons/airlocks/station/securityblue.dmi'

/obj/machinery/door/airlock/engineering
	icon = 'icons/airlocks/station/engineering.dmi'

/obj/machinery/door/airlock/medical
	icon = 'icons/airlocks/station/medical.dmi'

/obj/machinery/door/airlock/maintenance
	icon = 'icons/airlocks/station/maintenance.dmi'

/obj/machinery/door/airlock/maintenance/external
	icon = 'icons/airlocks/station/maintenanceexternal.dmi'

/obj/machinery/door/airlock/mining
	icon = 'icons/airlocks/station/mining.dmi'

/obj/machinery/door/airlock/atmos
	icon = 'icons/airlocks/station/atmos.dmi'

/obj/machinery/door/airlock/research
	icon = 'icons/airlocks/station/research.dmi'

/obj/machinery/door/airlock/freezer
	icon = 'icons/airlocks/station/freezer.dmi'

/obj/machinery/door/airlock/science
	icon = 'icons/airlocks/station/science.dmi'

/obj/machinery/door/airlock/virology
	icon = 'icons/airlocks/station/virology.dmi'

//STATION CUSTOM ARILOCKS
/obj/machinery/door/airlock/corporate
	icon = 'icons/airlocks/station/corporate.dmi'
...
/obj/machinery/door/airlock/service
	icon = 'icons/airlocks/station/service.dmi'
...
/obj/machinery/door/airlock/captain
	icon = 'icons/airlocks/cap.dmi'

/obj/machinery/door/airlock/hop
	icon = 'icons/airlocks/hop.dmi'

/obj/machinery/door/airlock/hos
	icon = 'icons/airlocks/hos.dmi'
...
/obj/machinery/door/airlock/psych
	icon = 'icons/airlocks/psych.dmi'

/obj/machinery/door/airlock/asylum
	icon = 'icons/airlocks/asylum.dmi'

/obj/machinery/door/airlock/bathroom
	icon = 'icons/airlocks/bathroom.dmi'

//STATION MINERAL AIRLOCKS
/obj/machinery/door/airlock/gold
	icon = 'icons/airlocks/station/gold.dmi'

/obj/machinery/door/airlock/silver
	icon = 'icons/airlocks/station/silver.dmi'

/obj/machinery/door/airlock/diamond
	icon = 'icons/airlocks/station/diamond.dmi'

/obj/machinery/door/airlock/uranium
	icon = 'icons/airlocks/station/uranium.dmi'

/obj/machinery/door/airlock/plasma
	icon = 'icons/airlocks/station/plasma.dmi'

/obj/machinery/door/airlock/bananium
	icon = 'icons/airlocks/station/bananium.dmi'

/obj/machinery/door/airlock/sandstone
	icon = 'icons/airlocks/station/sandstone.dmi'

/obj/machinery/door/airlock/wood
	icon = 'icons/airlocks/station/wood.dmi'

//STATION 2 AIRLOCKS

/obj/machinery/door/airlock/public
	icon = 'icons/airlocks/station2/glass.dmi'
	overlays_file = 'icons/airlocks/station2/overlays.dmi'

//EXTERNAL AIRLOCKS
/obj/machinery/door/airlock/external
	icon = 'icons/airlocks/external/external.dmi'
	overlays_file = 'icons/airlocks/external/overlays.dmi'

//CENTCOM
/obj/machinery/door/airlock/centcom
	icon = 'icons/airlocks/centcom/centcom.dmi'
	overlays_file = 'icons/airlocks/centcom/overlays.dmi'
...
/obj/machinery/door/airlock/vault
	icon = 'icons/airlocks/vault/vault.dmi'
	overlays_file = 'icons/airlocks/vault/overlays.dmi'

//HATCH
/obj/machinery/door/airlock/hatch
	icon = 'icons/airlocks/hatch/centcom.dmi'
	overlays_file = 'icons/airlocks/hatch/overlays.dmi'

/obj/machinery/door/airlock/maintenance_hatch
	icon = 'icons/airlocks/hatch/maintenance.dmi'
	overlays_file = 'icons/airlocks/hatch/overlays.dmi'

//HIGH SEC
/obj/machinery/door/airlock/highsecurity
	icon = 'icons/airlocks/highsec/highsec.dmi'
	overlays_file = 'icons/airlocks/highsec/overlays.dmi'

//TITANIUM / SHUTTLE
/obj/machinery/door/airlock/titanium
	icon = 'icons/airlocks/shuttle/shuttle.dmi'
	overlays_file = 'icons/airlocks/shuttle/overlays.dmi'
...
/obj/machinery/door/airlock/shuttle/ferry
	icon = 'icons/airlocks/shuttle2/erokez.dmi'
	overlays_file = 'icons/airlocks/shuttle2/overlays.dmi'

/obj/machinery/door/airlock/external/wagon
	icon = 'icons/airlocks/shuttle2/wagon.dmi'
	overlays_file = 'icons/airlocks/shuttle2/overlays.dmi'

//SURVIVAL
/obj/machinery/door/airlock/survival_pod
	overlays_file = 'icons/airlocks/survival/overlays.dmi'

//ABDUCTOR
/obj/machinery/door/airlock/abductor
	overlays_file = 'icons/airlocks/abductor/overlays.dmi'

//CULT
/obj/machinery/door/airlock/cult
	overlays_file = 'icons/airlocks/cult/runed/overlays.dmi'

/obj/machinery/door/airlock/cult/unruned
	overlays_file = 'icons/airlocks/cult/unruned/overlays.dmi'

//CLOCKWORK
/obj/machinery/door/airlock/bronze
	overlays_file = 'icons/airlocks/clockwork/overlays.dmi'

//MULTI-TILE

/obj/machinery/door/airlock/multi_tile
	icon = 'icons/airlocks/multi_tile/glass.dmi'
	overlays_file = 'icons/airlocks/multi_tile/glass_overlays.dmi'
...
/obj/machinery/door/airlock/multi_tile/metal
	icon = 'icons/airlocks/multi_tile/metal.dmi'
	overlays_file = 'icons/airlocks/multi_tile/metal_overlays.dmi'

//TRAM

/obj/machinery/door/airlock/tram
	name = "tram door"
	icon = 'icons/airlocks/tram/tram.dmi'
	overlays_file = 'icons/airlocks/tram/tram_overlays.dmi'
...
/obj/machinery/door/airlock/hydroponics
	icon = 'icons/airlocks/station/botany.dmi'
